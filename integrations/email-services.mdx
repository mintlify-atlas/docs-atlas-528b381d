...
<CardGroup cols={2}>
  <Card title="Content Modules" icon="rectangle-list" href="/api/modules/content-modules">
    Subscribe and contact form modules
  </Card>
  
  <Card title="Custom Services" icon="message" href="/api/services/custom-services">

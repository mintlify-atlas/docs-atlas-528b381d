...
<CardGroup cols={2}>
  ...
  <Card title="Settings Forms" icon="sliders" href="/developer/module-settings">
    Learn about all available field types
  </Card>
  <Card title="Available Modules" icon="star" href="/api/modules/basic-modules">
    Complete list of built-in modules
  </Card>
  <Card title="API Reference" icon="book" href="/api/fl-builder-module">

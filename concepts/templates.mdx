...
<CardGroup cols={2}>
  <Card title="Layouts" icon="code" href="/building/layouts">
    Work with layout templates
  </Card>
  <Card title="Cloud Templates" icon="file-code" href="/extensions/cloud-templates">
    Access cloud template library
  </Card>
  <Card title="Global Settings" icon="palette" href="/building/global-settings">
    Configure global styling
  </Card>
  <Card title="Architecture" icon="download" href="/concepts/architecture">
